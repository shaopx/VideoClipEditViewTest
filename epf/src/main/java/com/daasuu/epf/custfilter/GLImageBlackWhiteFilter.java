...
public class GLImageBlackWhiteFilter extends GlFilter {
    ...
    public GLImageBlackWhiteFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLImageBlackWhiteFilter(String vertexShader, String fragmentShader) {
